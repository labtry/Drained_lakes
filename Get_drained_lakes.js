...
var aoi = ee.FeatureCollection("users/arctic_drain/NCSCDv2_circumpolar_WGS84"),
var river_shp = ee.FeatureCollection("users/shp/river"),
var roi = ee.FeatureCollection("users/large_alaska"),
var image3 = ee.Image("users/image/Water_mosaic");
